...
* __The 3D-printed case's inner diameter (where the two-way glass and regular mirror are housed) is exactly 9 inches. This means that the two-way mirror and regular mirror won't fit unless the diameter of each is reduced by 2mm. Alternatively, the fusion 360 file may be modified to slightly increase the inner diameter to better accomodate the mirrors.__
